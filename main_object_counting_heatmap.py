...
classes_for_heatmap = list(range(141))  # Count all classes
...
video_writer = cv2.VideoWriter("heatmap_output_Fish_762201373_cam2.avi", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
...
while cap.isOpened():
    ...
    print('tracks for heatmap',tracks)
