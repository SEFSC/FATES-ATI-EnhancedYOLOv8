...
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2019_Sojo_Video_framecount812.csv'
#video_dir = '/work/cshah/unseen_videos_jackonedrive/2019 Pisces Video'
#csv_dir = '/work/cshah/generated_csv_yolo/2019_Pisces_Video'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2019_Pisces_Video_framecount812.csv'
#video_dir = '/work/cshah/unseen_videos_jackonedrive/2021 Pisces'
#csv_dir = '/work/cshah/generated_csv_yolo/2021_Pisces'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2021_Pisces_Video_framecount812.csv'
#video_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Pisces Video'
#csv_dir = '/work/cshah/generated_csv_yolo/2022_Pisces_video'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2022_Pisces_Video_countFrames812.csv'
...
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2022_Sojo_Video_countframes.csv'

#video_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Sojo Video_done/try'
#csv_dir = '/work/cshah/generated_csv_yolo/2022_Sojo_Video/try'
##output_csv_path = '/work/cshah/frame_counts_unseen_videos/2022_Sojo_942205003_cam3.csv'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2022_Sojo_try_counts.csv'


##for Active learning CSV frame count
#video_dir = '/work/cshah/unseen_videos_jackonedrive/2019 Sojo Video'
#csv_dir = '/work/cshah/unseen_videos_jackonedrive/2019 Sojo Video/2019 Sojo Video_CSV'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2019_Sojo_AL_framecount812.csv'

video_dir = '/work/cshah/unseen_videos_jackonedrive/2019 Pisces Video'
csv_dir = '/work/cshah/unseen_videos_jackonedrive/2019 Pisces Video/2019_Pisces_CSVs'
output_csv_path = '/work/cshah/frame_counts_unseen_videos/2019_Pisces_AL_framecount812.csv'

#video_dir = '/work/cshah/unseen_videos_jackonedrive/2021 Pisces'
#csv_dir = '/work/cshah/unseen_videos_jackonedrive/2021 Pisces/2021 Sojo Video_CSVs'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2021_Pisces_AL_framecount812.csv'

#video_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Pisces Video'
#csv_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Pisces Video/CSVs'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2022_Pisces_AL_framecount812.csv'

#video_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Sojo Video_done'
#csv_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Sojo Video_done/2022 Sojo Video_CSVs'
#output_csv_path = '/work/cshah/frame_counts_unseen_videos/2022_Sojo_AL_framecount812.csv'
...
for video_file in os.listdir(video_dir):
    if video_file.endswith('.avi'):  # Adjust extension if needed
        ...
        #YOLO based CSV reader
        #csv_file_name = f"{base_name}_detections.csv"
        #Active learning based CSV reader
        csv_file_name = f"detection_{base_name}.csv"
...
results = [
    ['Total number of unique frame identifiers (multiple fish species)', total_unique_frames],
    ['Total number of detections (single fish)', total_frames_from_csv],
