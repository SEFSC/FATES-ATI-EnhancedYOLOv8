...
#model.train(data="pasca_data_GFISHERD24_new.yaml", epochs=500)
model.train(data="pasca_data_GFISHERD24_new.yaml", epochs=200)
...
test_metrics = model.val(data='pasca_data_GFISHERD24_new.yaml', split='test',save_json=True)
