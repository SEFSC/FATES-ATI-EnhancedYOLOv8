...
# Define line points and classes to count
line_points = [(20, 400), (1080, 400)]
classes_to_count = [0, 141]  # Update this list with the class IDs you want to count
...
counter = solutions.ObjectCounter(
    ...
    view_img=False,  # Set to False to avoid unnecessary GUI windows
    reg_pts=line_points,
    draw_tracks=True,
    line_thickness=2,
)
...
while cap.isOpened():
    ...
    if results:
        if len(results[0].boxes) > 0:
            ...
            # Perform counting
            im0 = counter.start_counting(im0, boxes)
        else:
