...
#video_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Pisces Video/missing_downloads'
video_dir = '/work/cshah/mmtracking_cshah/data/GFISHERS24/check_labels'
frame_dir = '/work/cshah/extracted_frames_yolo_22Pisces'
#csv_output_dir = '/work/cshah/generated_csv_yolo/2022_Pisces_video'
csv_output_dir = '/work/cshah/updatedYOLOv8/ultralytics/runs/detect'
...
# Iterate over all video files in the directory in their original order
for video_file in os.listdir(video_dir):
    if not video_file.endswith('.avi'):
        continue

    csv_file_path = os.path.join(csv_output_dir, f"{os.path.splitext(video_file)[0]}_detections.csv")
    
    # Check if the CSV file already exists
    if os.path.exists(csv_file_path):
        print(f"CSV for {video_file} already exists. Skipping...")
        continue
