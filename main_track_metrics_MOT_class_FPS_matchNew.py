...
# Determine the offset between YOLO predictions and ground truth
gt_start_frame = min(frames_with_gt)
yolo_start_frame = 1  # Assuming YOLO starts from frame 1
frame_offset = gt_start_frame - yolo_start_frame
...
with open('New_filtered_track_results_yolo_mot.txt', 'w') as f:
    for frame_id, result in enumerate(results):
        corresponding_gt_frame = int(frame_id // fps_ratio) + yolo_start_frame + frame_offset
