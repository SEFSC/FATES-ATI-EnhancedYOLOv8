...
## Directories
#video_dir = '/ngi/nmfs-em/Backups_Nabi/2022 Sojo Video_done'
video_dir = '/work/cshah/unseen_videos_jackonedrive/2022 Sojo Video_done'
frame_dir = '/work/cshah/extracted_frames_yolo'
csv_output_dir = '/work/cshah/generated_csv_yolo'
...
for video_file in os.listdir(video_dir):
    ...
    while True:
        ...
        if frame_count % int(cap.get(cv2.CAP_PROP_FPS) / frame_rate) == 0:
            frame_filename = f"{video_file}_{frame_count // int(cap.get(cv2.CAP_PROP_FPS) / frame_rate) + 1}.png"
    ...
    # Release the video capture and delete the frames
    cap.release()
